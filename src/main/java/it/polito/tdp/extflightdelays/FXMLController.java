...
//    	this.model.creaGrafo2(n);
    ...
    public void setModel(Model model) {
    	this.model = model;
    	List<Airport> aereoporti =this.model.getAllAirports();
    	cmbBoxAeroportoPartenza.getItems().setAll(aereoporti);
    	cmbBoxAeroportoDestinazione.getItems().setAll(aereoporti);
    }
}